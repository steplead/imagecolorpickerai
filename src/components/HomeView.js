...
const EN_FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. The picker runs entirely in your browser — there is no sign-up and no limit on how many images you can open in a session.',
  },
  {
...
const labels = {
  ...
  pt: {
    ...
    desc: 'Extraia códigos HEX, RGB e paletas de cores de qualquer imagen instantaneamente. Seletor de cores AI gratuito, sem cadastro.',
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-400">
                  {t.dnaTitle.split('Your ')[1] || 'Color DNA'}
                </span>
              </h2>
