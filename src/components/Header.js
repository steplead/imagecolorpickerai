...
export default function Header() {
    ...
    const getLocalizedLinks = (pathname) => {
        ...
        const translations = {
            en: { red: 'Imperial Red', blue: 'Misty Blue', green: 'Jade Valley', scan: 'Color Style Scan', widget: 'Embed' },
            zh: { red: '中国红', blue: '雾霾蓝', green: '翡翠谷', scan: '色彩风格扫描', widget: '嵌入' },
            ja: { red: '帝国赤', blue: '霧色', green: '翡翠の谷', scan: 'カラースタイルスキャン', widget: '埋め込み' },
            es: { red: 'Rojo Imperial', blue: 'Azul Nebuloso', green: 'Valle de Jade', scan: 'Escaneo de Estilo de Color', widget: 'Incrustar' },
            fr: { red: 'Rouge Impérial', blue: 'Bleu Brumeux', green: 'Vallée de Jade', scan: 'Scan de Style de Couleur', widget: 'Intégrer' },
            de: { red: 'Kaiserrot', blue: 'Nebelblau', green: 'Jadeland', scan: 'Color Style Scan', widget: 'Einbetten' },
            pt: { red: 'Vermelho Imperial', blue: 'Azul Nevoado', green: 'Vale de Jade', scan: 'Scan de Estilo de Cor', widget: 'Incorporar' },
        };
